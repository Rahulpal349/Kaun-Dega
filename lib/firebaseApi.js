...
export const api = {
  ...
  async addExpense({ groupId, description, amount, paidBy, splitType, shares, memberIds, splitData }) {
    const group = await this.getGroup(groupId);
  ...
  async updateExpense(expenseId, { groupId, description, amount, paidBy, splitType, shares, memberIds, splitData }) {
    const group = await this.getGroup(groupId);
    const payerMember = group.members?.[paidBy] || { id: paidBy, name: 'Member' };
